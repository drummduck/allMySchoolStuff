...
#include "../edu-app-team-boujee/mycanvas.h"
...
void MyCanvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setCannonAngle((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject MyCanvas::staticMetaObject = {
    { &QSFMLCanvas::staticMetaObject, qt_meta_stringdata_MyCanvas.data,
...
void *MyCanvas::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MyCanvas.stringdata0))
