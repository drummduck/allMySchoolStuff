...
const QMetaObjectExtraData LoginForm::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject LoginForm::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LoginForm,
      qt_meta_data_LoginForm, &staticMetaObjectExtraData }
};
