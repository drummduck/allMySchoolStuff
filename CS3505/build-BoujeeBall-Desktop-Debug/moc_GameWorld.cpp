...
static const char qt_meta_stringdata_GameWorld[] = {
    "GameWorld\0\0score\0success(int)\0"
    "onTopBasketHit()\0onBotBasketHit()\0"
};
...
void GameWorld::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onTopBasketHit(); break;
        case 2: _t->onBotBasketHit(); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData GameWorld::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject GameWorld::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GameWorld,
      qt_meta_data_GameWorld, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &GameWorld::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GameWorld))
...
// SIGNAL 0
void GameWorld::success(int _t1)
{
