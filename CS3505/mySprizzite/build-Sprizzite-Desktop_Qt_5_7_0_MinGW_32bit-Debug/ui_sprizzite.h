...
"    margin-left: 5px;\n"
"    border: 1px solid t"
                        "ransparent; /* reserve space for selection border */\n"
"}\n"
"\n"
"QMenu::item:selected\n"
"{\n"
...
"background-position: center;"));
        ...
        fasterButton->setStyleSheet(QLatin1String("background-image: url(:/buttons/buttons/fastForward.jpg);\n"
"background-repeat: no-repeat;\n"
"background-attachment: fixed;\n"
"background-position: left;"));
        ...
        slowerButton->setStyleSheet(QLatin1String("background-image: url(:/buttons/buttons/rewind.jpg);\n"
"background-repeat: no-repeat;\n"
"background-attachment: fixed;\n"
"background-position: center;"));
...
#ifndef QT_NO_TOOLTIP
        zoomIn->setToolTip(QApplication::translate("Sprizzite", "Zoom In", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        eraseButton->setToolTip(QApplication::translate("Sprizzite", "Rotate selection", 0));
#endif // QT_NO_TOOLTIP
