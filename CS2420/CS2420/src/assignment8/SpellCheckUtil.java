 ...
 */
public class SpellCheckUtil 			//UNTESTED
{
  private HashTable dictionary;
  private GoodHashFunctor goodFunctor = new GoodHashFunctor();		
  /**
   * Default constructor--creates empty dictionary.
   */
  public SpellCheckUtil() 
  {
    dictionary = new QuadProbeHashTable(11, goodFunctor);
  }
...
//  }
  ...
  public List<String> spellCheck(File documentFile) 
  {
	...
	ArrayList<String> MisspelledWords = new ArrayList<String>();
	 ...
	 for(String o: wordsToCheck)
	 {
		 if(dictionary.contains(o) == false)
		 {
			 MisspelledWords.add(o);
		 }
	 }
