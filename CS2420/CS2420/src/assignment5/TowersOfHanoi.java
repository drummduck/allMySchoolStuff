    ...
    public void moveDiscSingle (char from, char to) throws Exception
    {
    	...
    	if(from == 'A')
    	{
    		...
    		else if (to == 'B')
    		{
    			...
    			else if (towerA.peek().compareTo(towerB.peek()) < 0)
    			{
    				towerB.push(towerA.pop());
    				this.numOfMoves++;
    			}
    			else throw new Exception("Abort! Illegal Disc Movement");
    		}
    		else if (to == 'C')
    		{
    			if(towerC.size() == 0)
    			...
    			else if (towerA.peek().compareTo(towerC.peek()) < 0)
    			{
    				towerC.push(towerA.pop());
    				this.numOfMoves++;
    			}
    		...
    		else throw new Exception("Abort! Illegal tower char ID!");
    	...
    	else if(from == 'B')
    	{
    		...
    		else if (to == 'A')
    		{
    			...
    			else if (towerB.peek().compareTo(towerA.peek()) < 0)
    			{
    				towerA.push(towerB.pop());
    				this.numOfMoves++;
    			}
    		...
    		else if (to == 'C')
    		{
    			...
    			else if (towerB.peek().compareTo(towerC.peek()) < 0)
    			{
    				towerC.push(towerB.pop());
    				this.numOfMoves++;
    			}
    	...
    	else if(from == 'C')
    	{
    		...
    		else if (to == 'A')
    		{
    			...
    			else if (towerC.peek().compareTo(towerA.peek()) < 0)
    			{
    				towerA.push(towerC.pop());
    				this.numOfMoves++;
    			}
    		...
    		else if (to == 'B')
    		{
    			...
    			else if (towerC.peek().compareTo(towerB.peek()) < 0)
    			{
    				towerB.push(towerC.pop());
    				this.numOfMoves++;
    		...
    		throw new Exception ("Abort! Illegal tower char ID");
