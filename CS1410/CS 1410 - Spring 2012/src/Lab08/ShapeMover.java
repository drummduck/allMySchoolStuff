                                                   ...
                                                   MouseMotionListener
{
	...
	shapes = new Shape[]
	    {
	       ...
	       new Rect    ( 30, 140, 40,40, Color.YELLOW),
	       new Circle (40,60,80,Color.ORANGE)
	    };
	...
	// Note - a better but more complicated way to do double buffering
	//  is to use BufferStrategy objects.
    }
