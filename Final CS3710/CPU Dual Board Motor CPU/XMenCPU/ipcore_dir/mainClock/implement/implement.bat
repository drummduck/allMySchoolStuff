...
xst -ifn xst.scr
move mainClock_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\mainClock_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc mainClock_exdes.ucf mainClock_exdes

echo 'Running map'
map -timing -pr b mainClock_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm mainClock_exdes -w routed.ncd routed.v
cd ..
